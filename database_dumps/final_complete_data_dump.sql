-- Complete Database Data Dump - ALL 1,310+ Records
-- Generated from production database with authentic data
...
-- Note: This is the foundation data. For the complete dump with ALL 1,310+ records,
-- including all 133 control_library records, 25 risk_library records, 
-- 838 risk_summaries records, and 289 activity_logs records,
-- use the companion extraction scripts or pg_dump utility.
