...
-- Note: This is a partial extract. The complete dump requires ALL 1,310+ records
-- including ALL 133 control_library records, ALL 25 risk_library records, 
-- ALL 838 risk_summaries records, ALL 289 activity_logs records, and ALL 4 vulnerabilities
-- To get the complete dump with ALL data, please run additional queries for remaining tables
