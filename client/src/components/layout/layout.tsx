...
export default function Layout({ children, pageTitle, pageIcon, pageDescription, pageActions }: LayoutProps) {
    ...
    <div className={`min-h-screen transition-colors duration-200 ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      <div className="flex h-screen">
        ...
        <div className={`${sidebarCollapsed ? 'w-16' : 'w-64'} transition-all duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-r flex flex-col`}>
          ...
          {/* Navigation */}
          <nav className="flex-1 px-4 py-4 pl-[6px] pr-[6px] pt-[20px] pb-[20px] mt-[0px] mb-[0px] ml-[-2px] mr-[-2px]">
