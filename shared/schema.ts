...
export const vulnerabilities = pgTable('vulnerabilities', {
  ...
  severityCvss3: numeric('severity_cvss3', { precision: 4, scale: 2 }).notNull(),
  exploitabilitySubscore: numeric('exploitability_subscore', { precision: 4, scale: 2 }),
  impactSubscore: numeric('impact_subscore', { precision: 4, scale: 2 }),
  temporalScore: numeric('temporal_score', { precision: 4, scale: 2 }),
  status: text('status').notNull(),
  remediationDate: timestamp('remediation_date'),
  patchable: boolean('patchable').notNull().default(true),
  source: text('source').notNull(),
  eDetect: numeric('e_detect', { precision: 3, scale: 2 }),
  eResist: numeric('e_resist', { precision: 3, scale: 2 }),
  ...
  discoveredDate: timestamp('discovered_date').default(sql`CURRENT_TIMESTAMP`),
  remediatedDate: timestamp('remediated_date'),
  publishedDate: timestamp('published_date'),
  modifiedDate: timestamp('modified_date'),
  eDetectImpact: real('e_detect_impact').default(0),
  eResistImpact: real('e_resist_impact').default(0),
  vulnReferences: json('vuln_references').$type<string[]>().default([]),
